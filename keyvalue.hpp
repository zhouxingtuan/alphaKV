...
typedef struct BlockNode {
	...
	inline BlockNode &operator=(uint64 v)
	{
		this->value = v;
		return *this;
	}
	inline BlockNode &operator=(const BlockNode &other)
	{
	...
	inline bool operator==(const BlockNode &other) const
	{
...
template <uint64 _KEY_SLOT_NUMBER_> class KeyValue : public File
{
	public:
	...
	inline int set(const char *key, int64 keyLen, const void *value, int64 valueLen,
				   bool recordLength, bool setNotExist)
	{
		int64 saveLength;
		if (recordLength) {
